...
/**
 * Created by qiankai on 11/13/14.
 * This example indicate how to use mapreduce on Galaxy SDS, with one scan on single table.
 ...
 */
public class SDSSingleTableOneScan extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    Job job = Job.getInstance(conf, "open-computing-codelab-sds-single-table-one-scan");
    ...
    job.setJarByClass(SDSSingleTableOneScan.class);
    return job.waitForCompletion(true) ? 0 : 1;
  }

  public static void main(String[] args) throws Exception {
    int exitCode = ToolRunner.run(new SDSSingleTableOneScan(), args);
